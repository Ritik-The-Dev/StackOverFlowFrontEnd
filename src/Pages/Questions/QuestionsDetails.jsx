...
const QuestionsDetails = () => {
  ...
  const [showCodeEditor,setshowCodeEditor] = useState("Show Code")
  ...
  const showCode = (e)=>{
    e.preventDefault();
    let showCode = document.querySelector(".CodeAreas");
    if(showCode.classList.contains("hidden")){
    setshowCodeEditor("Hide Code")
    alert("Pls Scroll Down to Saw Code")}
    else{
      setshowCodeEditor("Show Code")
    }
    showCode.classList.toggle("hidden")
  }
  return (
